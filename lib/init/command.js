...
export function setting () {
  if (!getActivePioProject()) {
    const reason = '请确认您当前打开的工程为IntoYunIoT项目工程（例如：工程内包括intoyuniot.ini文件）';
    atom.notifications.addError('当前工程不是IntoYunIoT项目工程', { detail: reason, dismissable: true});
    return
  }
