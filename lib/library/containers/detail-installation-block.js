    ...
    return (
      <div>
        ...
        <ul className='list-inline'>
          ...
          <li>
            <select ref={ item => this.versionSelect = item } className='input-select'>
          ...
          <li>
            <button onClick={ (e) => this.onDidVersionInstall(e, this.versionSelect.value) } className='btn btn-primary icon icon-cloud-download'>
              Install
            </button>
          </li>
        </ul>
