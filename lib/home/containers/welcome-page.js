  ...
  render() {
    return (
      <section className='page-container welcome-page'>
        <h1 className='section-heading icon icon-home'>欢迎使用<a href='http://iot.intoyun.com'>IntoYunIoT IDE</a></h1>
        <div className='block row text-center'>
          <div className='col-xs pio-logo-versions'>
            <a href='http://iot.intoyun.com'>
              <PlatformIOLogo />
            </a>
            <PioVersions />
          </div>
        ...
        */}
        <h2 className='block section-heading icon icon-file-submodule'>最近打开的工程</h2>
        <RecentProjectsBlock />
        {/*
        <hr />
