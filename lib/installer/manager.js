  ...
  constructor() {
    ...
    this.stages = [
      ...
      new PlatformIOCoreStage(this.eventbus, {
        useBuiltinPIOCore: atom.config.get('intoyuniot-ide.useBuiltinPIOCore'),
        setUseBuiltinPIOCore: (value) => atom.config.set('intoyuniot-ide.useBuiltinPIOCore', value),
        useDevelopmentPIOCore: atom.config.get('intoyuniot-ide.advanced.useDevelopmentPIOCore') || semver.prerelease(utils.getIDEVersion())
      })
    ];
  ...
  install() {
    ...
    return Promise.all(
      ...
      atom.notifications.addSuccess(
        'IntoYunIoT IDE has been successfully installed!',
        {
