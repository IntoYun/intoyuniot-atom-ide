...
export default class PlatformIOCoreStage extends BaseStage {
  ...
  async whereIsPython() {
    ...
    do {
      ...
      buttonIndex = atom.confirm({
        message: 'IntoYunIoT: Can not find Python 2.7 Interpreter',
        detailedMessage: 'IntoYunIoT Core is written in Python and depends on it. ' +
        ...
        buttons: [
          ...
          'I have Python 2.7',
          'Try again',
          'Abort IntoYunIoT IDE Installation'
        ]
      });
  ...
  async check() {
    ...
    console.debug(`Found IntoYunIoT Core ${coreVersion}`);
    return true;
  }
