...
export class BoardsSelectView extends BaseView {
  ...
  filterBoardsChoices() {
    ...
    defaultOption.textContent = '-- 选择开发板 --';
    ...
    for (const boardId of sortedKeys) {
      ...
      this.boardsSelect.appendChild(option);
    }
  ...
  setSelectedBoard (boardId) {
    const boardIndex = this.allBoards.findIndex(board => board.id === boardId);
    this.selectedBoards.add(boardIndex);
    this.boardsSelect.value = boardIndex;
  }
}
